  ...
  return (
    <footer className="bg-black text-neutral-400 sm:px-8 px-16 py-10 border-t border-neutral-600">
      ...
      <p className="md:text-sm text-xs md:w-1/2 w-full">
        ...
        maintained by their users. More infos: <a href="https://www.omdbapi.com/" target="_blank" className="footer-link">www.omdbapi.com</a> <br />
        <a href="https://de.vecteezy.com/gratis-vektor/kino" target="_blank" className="footer-link">Background image from Vecteezy</a>
      </p>
    </footer>
  );
};
